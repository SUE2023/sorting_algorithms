 ...
 * Description: Gets the numerical alue of a card
...
/**
 * insertion_sort_deck_kind - Sort a deck of cards
 * Description: from spades to diamonds
 ...
 * Description: sorted from spades to diamonds from ace to king
 * @deck: A pointer to the head of a deck_node_t doubly-linked list
 * Return: void
 */
void insertion_sort_deck_value(deck_node_t **deck)
 ...
 * Description: and from spades to diamonds
 * @deck: A pointer to the head of a deck_node_t doubly-linked list
 * Return: void
 */
void sort_deck(deck_node_t **deck)
